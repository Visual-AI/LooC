...
class VectorQuantiser(nn.Module):
    ...
    def __init__(self, num_embed, embed_dim, beta, distance='cos', 
        ...
        print(f"VectorQuantiser: codebook_size = num_embed * embed_dim = {self.num_embed} * {self.embed_dim} = {self.codebook_size}")
...
class EfficientVectorQuantiser(nn.Module):
    ...
    def forward(self, z, temp=None, rescale_logits=False, return_logits=False):
        ...
        return z_q, loss, sim_loss, (encoding_indices, bin_count)
